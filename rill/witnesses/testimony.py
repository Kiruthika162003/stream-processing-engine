...
class Testimony:
    ...
    def __post_init__(self) -> None:
        if not self.witness.strip() or not self.claim.strip():
            raise Invalid(
                "testimony needs a witness and a claim; "
